...
public class MemberLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(dt1, javax.swing.GroupLayout.PREFERRED_SIZE, 182, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(jLabel4, javax.swing.GroupLayout.PREFERRED_SIZE, 22, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(67, 67, 67)
                .addComponent(dt2, javax.swing.GroupLayout.PREFERRED_SIZE, 155, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jt5.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "MID", "LOGIN DATE", "LOGIN TIME", "LOGOUT DATE", "LOGOUT TIME"
            }
        ) {
        ...
        jScrollPane1.setViewportView(jt5);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       int r=jt5.getRowCount();
  
 DefaultTableModel dtm = (DefaultTableModel)jt5.getModel();
    while(r-- !=0){
  dtm.removeRow(0);
        ...
        try {
            ...
            ResultSet rs = st.executeQuery("select * from mlogindetails where logind >= '"+d1+"' and logoutd<='"+d2+"'");  
             ...
             Vector row= new Vector();
                   row.add(rs.getString(2));
                    ...
                    row.add(rs.getString(4));
                     ...
                     dtm = (DefaultTableModel)jt5.getModel();
                   dtm.addRow(row);
